...
public class WindowMain {
	...
	public static void main(String[] args) {
		...
		if (args.length != 0) {
			...
			if (argsResult.success() != true) {
	            ...
	            System.err.println("");
				System.err.println("Usage: java -jar Minecraft.ID.Resolver.v1.0.5.2.jar ");
			...
			System.out.println("");
			System.out.println("Minecraft ID Resolver v1.0.5.2 - By SS111");
	...
	private void initialize() {
		...
		frmMain = new JFrame();
		frmMain.setTitle("Minecraft ID Resolver V1.0.5.2 - By SS111");
